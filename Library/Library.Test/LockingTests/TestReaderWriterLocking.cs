...
namespace CSharpTest.Net.Library.Test.LockingTests
{
    ...
    [TestFixture]
    public class TestReaderWriterLockingDebug : BaseThreadedReaderWriterTest<DebugLockFactory<ReaderWriterLocking>>
    {
    }
    [TestFixture]
    public class TestReaderWriterLockingCounts : BaseThreadedReaderWriterTest<LockCounterFactory<ReaderWriterLocking>>
    {
    }
}