...
namespace CSharpTest.Net.Library.Test.LockingTests
{
    ...
    [TestFixture]
    public class TestSimpleReadWriteLockingDebug : BaseThreadedReaderWriterTest<DebugLockFactory<SimpleReadWriteLocking>>
    {
    }
    [TestFixture]
    public class TestSimpleReadWriteLockingCounts : BaseThreadedReaderWriterTest<LockCounterFactory<SimpleReadWriteLocking>>
    {
    }
}