...
namespace CSharpTest.Net.Library.Test.LockingTests
{
    ...
    [TestFixture]
    public class TestReservedWriteLocking : TestReservedWriteLocking<LockFactory<ReservedWriteLocking<SimpleReadWriteLocking>>>
    {
    }
    [TestFixture]
    public class TestReservedWriteLockingDebug : TestReservedWriteLocking<DebugLockFactory<ReservedWriteLocking<SimpleReadWriteLocking>>>
    {
    }
    [TestFixture]
    public class TestReservedWriteLockingCounts : TestReservedWriteLocking<LockCounterFactory<ReservedWriteLocking<SimpleReadWriteLocking>>>
    {
    }
}
