...
namespace CSharpTest.Net.Library.Test.LockingTests
{
    ...
    [TestFixture]
    public class TestWriterOnlyLockingDebug : BaseThreadedWriterTest<DebugLockFactory<WriterOnlyLocking>>
    {
    }
    [TestFixture]
    public class TestWriterOnlyLockingCounts : BaseThreadedWriterTest<LockCounterFactory<WriterOnlyLocking>>
    {
    }
}
